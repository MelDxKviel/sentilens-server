...
async def send_password_reset_notification(recipient_email: str, reset_code: str):
    templare_body = {
    ...
    try:
        ...
        fm = FastMail(email_config)
        await fm.send_message(message, template_name="password_reset_notification.html")
    except Exception as e:
        logger.error(f"Something went wrong in password reset email notification")
        logger.error(str(e))
